  ...
  return (
    <div className='w-full h-[100vh] flex items-center justify-center'>
     <div className='w-[450px] min-h-[520px] border rounded-md shadow-md bg-white'>
      <div>
         <p className='text-[23px] font-bold py-8 items-center flex'> Create your  Account</p>
      ...
      <div className='border-b w-full'/>
         ...
         <div>
            ...
            className='m-4 border rounded-sm outline-none w-[90%] h-12 px-2 my-2'
            value={companyName}
            onChange={(e:any)=>{
           ...
           <input placeholder='Email'
            ...
            <br />
            <br />
            <button className='mx-4 border rounded-sm outline-none w-[90%]
            h-12 px-2 my-2'
            onClick={()=>{
              createUser();
              console.log("Clicked")
